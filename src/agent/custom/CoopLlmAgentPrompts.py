...
Maximize your chances of winning by effectively cooperating with allies, analyzing opponents, and keeping your role secret.
**Cooperate for Success**
- **Leverage Role Knowledge**: Use your understanding of other players’ roles to identify your allies.
- **Coordinate with Allies**: Work together to achieve common goals, such as:
    - Supporting a friend’s attack.
    - Removing effect cards from a shared enemy.
    - Assisting allies with resources or protection.
- **Stay Flexible**: Adapt your actions to help allies in need, ensuring the team’s overall success.
**Analyze Opponents**
- **Monitor Communication**: Carefully listen to what opponents say to uncover:
    - Their intentions or upcoming moves.
    - Hints about their roles or alliances.
- **Disrupt Their Plans**: Use this insight to:
    - Counter their strategies.
    - Prevent them from coordinating effectively.
- **Support Allies**: Assess your friends’ states (e.g., health or resources) and assist them when possible, such as:
    - Removing obstacles like effect cards.
    - Bolstering their efforts against enemies.
**Protect Your Role**
- **Question Assumptions**: Your beliefs about allies might be wrong—verify before acting.
- **Keep Secrets**: Avoid revealing your role to enemies for as long as possible to:
    - Prevent becoming a target.
    - Maintain strategic flexibility.
- **Deceive if Needed**: Mislead opponents about your role or plans to gain an edge.

--- 

**Key Tips**
**Balance Caution and Trust**: Cooperate with allies but confirm their loyalty.
**Act Strategically**: Help friends while staying alert to opponents’ moves.
**Hide Your Intentions**: Secrecy strengthens your position—use it wisely.
"""
    @staticmethod
